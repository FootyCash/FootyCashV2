...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04a893220ea7a38a7106385003fef77896538a382a0dcc389cc45f3c98751d9af423a097789757556259351198a8aaa628a1fd644c3232678c5845384c744ff8d7");
        nDefaultPort = 17017;
        nRPCPort = 17018;
        ...
        const char* pszTimestamp = "6 Aug 2017 The rebirth of FootyCash.";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1502010225, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1502010225;
        genesis.nBits    = 520159231; 
        genesis.nNonce   = 17113;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x109b78725fe6a614b5e89c6e891919f402fbc39d64b270686be3d6c928999659"));
        assert(genesis.hashMerkleRoot == uint256("0x29ea3371e36e7b64c6741db896e6ad4827fadeb3647ba04b8172ac22abfd141e"));
