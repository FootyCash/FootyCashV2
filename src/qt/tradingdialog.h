...
private slots:
    ...
    QString BuyXFT(QString OrderType, double Quantity, double Rate);
    QString SellXFT(QString OrderType, double Quantity, double Rate);
