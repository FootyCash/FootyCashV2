...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XFT");
    case mBTC: return QString("mXFT");
    case uBTC: return QString::fromUtf8("μXFT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XFTs");
    case mBTC: return QString("Milli-XFTs (1 / 1,000)");
    case uBTC: return QString("Micro-XFTs (1 / 1,000,000)");
    default: return QString("???");
    }
}
